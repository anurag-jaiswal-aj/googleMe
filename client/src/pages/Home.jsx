...
const TRANSLATIONS = {
  en: { offeredIn: 'Portfolio offered in:',         search: 'Search Portfolio',         lucky: "I'm Feeling Lucky",       earth: 'Earth',    about: 'About',          projects: 'Projects',       contact: 'Contact'       },
  hi: { offeredIn: 'पोर्टफोलियो उपलब्ध है:',          search: 'पोर्टफोलियो खोजें',        lucky: 'मैं भाग्यशाली हूँ',       earth: 'पृथ्वी',  about: 'परिचय',          projects: 'प्रोजेक्ट्स',  contact: 'संपर्क'        },
  bn: { offeredIn: 'পোর্টফোলিও পাওয়া যাচ্ছে:',       search: 'পোর্টফোলিও খুঁজুন',       lucky: 'আমি ভাগ্যবান',            earth: 'পৃথিবী', about: 'পরিচয়',          projects: 'প্রজেক্টস',    contact: 'যোগাযোগ'      },
  te: { offeredIn: 'పోర్ట్‌ఫోలియో అందుబాటులో:',      search: 'పోర్ట్‌ఫోలియో వెతకండి',  lucky: 'నేను అదృష్టవంతుడిని',     earth: 'భూమి',   about: 'పరిచయం',         projects: 'ప్రాజెక్టులు', contact: 'సంప్రదించు'   },
  mr: { offeredIn: 'पोर्टफोलिओ उपलब्ध आहे:',          search: 'पोर्टफोलिओ शोधा',          lucky: 'मी नशीबवान आहे',          earth: 'पृथ्वी',  about: 'माझ्याबद्दल',    projects: 'प्रोजेक्ट्स',  contact: 'संपर्क'        },
  ta: { offeredIn: 'போர்ட்ஃபோலியோ கிடைக்கிறது:',     search: 'போர்ட்ஃபோலியோ தேடுங்கள்', lucky: 'நான் அதிர்ஷ்டசாலி',       earth: 'பூமி',   about: 'என்னைப் பற்றி', projects: 'திட்டங்கள்',  contact: 'தொடர்பு'      },
  gu: { offeredIn: 'પોર્ટફોલિયો ઉપલબ્ધ છે:',          search: 'પોર્ટફોલિયો શોધો',         lucky: 'હું નસીબદાર છું',          earth: 'પૃથ્વી',  about: 'મારા વિશે',      projects: 'પ્રોજેક્ટ્સ', contact: 'સંપર્ક'        },
  kn: { offeredIn: 'ಪೋರ್ಟ್‌ಫೋಲಿಯೋ ಲಭ್ಯವಿದೆ:',       search: 'ಪೋರ್ಟ್‌ಫೋಲಿಯೋ ಹುಡುಕಿ',   lucky: 'ನಾನು ಅದೃಷ್ಟಶಾಲಿ',         earth: 'ಭೂಮಿ',   about: 'ನನ್ನ ಬಗ್ಗೆ',    projects: 'ಪ್ರಾಜೆಕ್ಟ್‌ಗಳು', contact: 'ಸಂಪರ್ಕ'    },
  ml: { offeredIn: 'പോർട്ട്ഫോളിയോ ലഭ്യമാണ്:',       search: 'പോർട്ട്ഫോളിയോ തിരയുക',   lucky: 'ഞാൻ ഭാഗ്യവാൻ',            earth: 'ഭൂമി',   about: 'എന്നെക്കുറിച്ച്', projects: 'പ്രൊജക്ടുകൾ', contact: 'ബന്ധപ്പെടുക' },
  pa: { offeredIn: 'ਪੋਰਟਫੋਲੀਓ ਉਪਲਬਧ ਹੈ:',           search: 'ਪੋਰਟਫੋਲੀਓ ਖੋਜੋ',          lucky: 'ਮੈਂ ਖੁਸ਼ਕਿਸਮਤ ਹਾਂ',        earth: 'ਧਰਤੀ',   about: 'ਮੇਰੇ ਬਾਰੇ',     projects: 'ਪ੍ਰੋਜੈਕਟ',    contact: 'ਸੰਪਰਕ'        },
};
...
export default function Home() {
  ...
  const handleKeyDown = (e) => {
    if (e.key === 'ArrowDown') {
      ...
      if (text.trim()) {
        setQuery(text); setFocused(false); setActiveIdx(-1);
        if (suggestion?.external) window.open(suggestion.to, '_blank', 'noopener,noreferrer');
  ...
  const AI_REPLIES = {
    ...
    stack:      'Primary stack: React, Node.js, Express, MongoDB, TailwindCSS. He\'s also comfortable with TypeScript, Docker, REST & GraphQL APIs, and Vite.',
    ...
    education:  'Anurag is studying Information Science & Engineering. He complements his academics with self-driven learning in modern web dev, system design, and software engineering.',
        ...
        >
              ...
              <div className="relative group/mic">
                ...
                >
                  <svg className="w-6 h-6" viewBox="0 0 24 24">
                    ...
                    <rect x="9" y="3" width="3" height="4.5" fill="#4285F4" clipPath="url(#home-mic-clip)"/>
                    <rect x="12" y="3" width="3" height="4.5" fill="#EA4335" clipPath="url(#home-mic-clip)"/>
                    <rect x="9" y="7.5" width="3" height="4.5" fill="#FBBC05" clipPath="url(#home-mic-clip)"/>
                    <rect x="12" y="7.5" width="3" height="4.5" fill="#34A853" clipPath="url(#home-mic-clip)"/>
                ...
                <div className="pointer-events-none absolute bottom-full left-1/2 -translate-x-1/2 mb-2
                  ...
                  <div className="bg-[#202124] dark:bg-[#e8eaed] text-white dark:text-[#202124]
                                  text-xs font-medium px-2.5 py-1 rounded-md whitespace-nowrap shadow-lg">
                    Voice search
                  </div>
                  <div className="w-2 h-2 bg-[#202124] dark:bg-[#e8eaed] rotate-45
          ...
          <AnimatePresence>
            {focused && filtered.length > 0 && (
              ...
              >
                <div className="py-1 overflow-y-auto" style={{ maxHeight: 'calc(5 * 41px)' }}>
                  {filtered.map((s, i) => (
                    <button
                      key={s.text}
                      onMouseDown={(e) => e.preventDefault()}
                      onClick={() => {
                        setQuery(s.text); setFocused(false); setActiveIdx(-1);
                        if (s.external) window.open(s.to, '_blank', 'noopener,noreferrer');
                        else navigate(s.to);
                      }}
                    ...
                    >
                      {s.icon === 'clock' ? (
                        <svg className="w-4 h-4 text-[#9aa0a6] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                      ...
                      <span className="flex-1 truncate">
                        {query.trim() ? (
                          s.text.toLowerCase().startsWith(query.toLowerCase()) ? (
                            <><span className="font-medium">{s.text.slice(0, query.length)}</span>{s.text.slice(query.length)}</>
                          ) : s.text
                        ) : s.text}
                      </span>
                      <svg
                        ...
                        onMouseDown={(e) => { e.stopPropagation(); e.preventDefault(); setQuery(s.text); inputRef.current?.focus(); }}
                      >
        ...
        {micOpen && (
          ...
          >
              ...
              <svg className="w-12 h-12" viewBox="0 0 24 24">
                {micState === 'listening' ? (
                  ...
                  <>
                    ...
                    <rect x="9" y="3" width="3" height="4.5" fill="#4285F4" clipPath="url(#modal-mic-clip)"/>
                    <rect x="12" y="3" width="3" height="4.5" fill="#EA4335" clipPath="url(#modal-mic-clip)"/>
                    <rect x="9" y="7.5" width="3" height="4.5" fill="#FBBC05" clipPath="url(#modal-mic-clip)"/>
                    <rect x="12" y="7.5" width="3" height="4.5" fill="#34A853" clipPath="url(#modal-mic-clip)"/>
                    <path fill="#4285F4" d="M6 11a6 6 0 0012 0h-1.5a4.5 4.5 0 01-9 0H6z"/>
                    <path fill="#4285F4" d="M11.25 17v2.5h1.5V17h-1.5z"/>
                    <path fill="#4285F4" d="M8.5 19.5h7v1h-7z"/>
                  </>
            ...
            {micState === 'result' && micTranscript && (
              <button
                onClick={() => { setMicOpen(false); navigate('/about'); }}
            ...
            >
              ...
              <div className="px-5 pb-3">
                <div className="flex gap-2">
                  ...
                  />
                  <button
                    onClick={() => { if (lensUrl.trim()) setLensImage(lensUrl.trim()); }}
              ...
              {lensImage ? (
                <div className="mx-5 mb-5 relative rounded-xl overflow-hidden border border-[#dadce0] dark:border-[#5f6368]">
                  ...
                  <button
                    onClick={() => { setLensImage(null); setLensUrl(''); }}
                      ...
                      <div className="bg-[#f1f3f4] dark:bg-[#2d2e30] px-4 py-3 rounded-2xl rounded-bl-sm flex items-center gap-1">
                        {[0, 1, 2].map(d => (
                          <motion.span
                            ...
                            animate={{ y: [0, -5, 0] }}
                            transition={{ duration: 0.55, delay: d * 0.15, repeat: Infinity }}
                          />
                        ))}
                      </div>
                    </motion.div>
                  ...
                  <nav className="w-full sm:w-[180px] shrink-0 border-b sm:border-b-0 sm:border-r border-[#e8eaed] dark:border-[#3c4043]
                    ...
                    {HELP_SECTIONS.map((s, i) => (
                      ...
                      >
                        ...
                        {s.label}
                        {helpSection === i && (
                          <span className="ml-auto w-1 h-4 rounded-full shrink-0" style={{ background: s.color }} />
                        )}
                      </button>
                    ))}
                  </nav>
                  ...
                  <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 sm:py-5">
                    ...
                    <div className="flex items-center gap-2.5 mb-5">
                      <div className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0"
                           style={{ background: sec.color + '1A', color: sec.color }}>
                        {sec.icon}
                      </div>
                      <div>
                        ...
                        <p className="text-[12px] text-[#9aa0a6] leading-tight">
                          {sec.items.length} topic{sec.items.length !== 1 ? 's' : ''}
                        </p>
                      </div>
                    </div>
