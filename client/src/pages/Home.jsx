                ...
                >
                  <div className="grid grid-cols-3 gap-1">
                    {[
                      {
                        label: "Search",
                        action: () => { navigate("/"); setAppsOpen(false); },
                        icon: (
                      ...
                      {
                        label: "Mail",
                        action: () => { navigate("/contact"); setAppsOpen(false); },
                        icon: (
                          <div className="w-12 h-12 rounded-xl bg-white shadow-sm border border-gray-100 flex items-center justify-center">
                      ...
                      {
                        label: "About",
                        action: () => { navigate("/about"); setAppsOpen(false); },
                        icon: (
                          <div className="w-12 h-12 rounded-xl bg-white shadow-sm border border-gray-100 flex items-center justify-center">
                      ...
                      {
                        label: "Works",
                        action: () => { navigate("/projects"); setAppsOpen(false); },
                        icon: (
                          <div className="w-12 h-12 rounded-xl bg-white shadow-sm border border-gray-100 flex items-center justify-center">
                            <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none">
                      ...
                      {
                        label: "Blogs",
                        action: () => { navigate("/blog"); setAppsOpen(false); },
                        icon: (
                          <div className="w-12 h-12 rounded-xl bg-white shadow-sm border border-gray-100 flex items-center justify-center">
                            <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none">
              ...
              {avatarOpen && (
                ...
                >
                  ...
                  <div className="py-1.5">
                    ...
                    <button
                      onClick={() => { setKpOpen(true); setAvatarOpen(false); }}
                      className="xl:hidden w-full flex items-center gap-3 px-5 py-2.5
                               text-[13.5px] text-[#202124] dark:text-[#e8eaed]
                               hover:bg-[#f1f3f4] dark:hover:bg-[#2d2e30] transition-colors"
                    >
                      <span className="flex-1 text-left">Knowledge Panel</span>
        ...
        {kpOpen && (
          ...
          >
            <motion.div
              ...
              transition={{ duration: 0.18 }}
              className="relative w-full max-w-[400px] max-h-[85vh] overflow-y-auto rounded-3xl
                         bg-white dark:bg-[#1e1f20] shadow-2xl border border-[#e8eaed] dark:border-[#3c4043]"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="flex items-center justify-between px-5 pt-4 pb-2">
                <span className="text-[15px] font-semibold text-[#202124] dark:text-[#e8eaed]">Knowledge Panel</span>
                <button
                  onClick={() => setKpOpen(false)}
                  className="p-1.5 rounded-full hover:bg-[#f1f3f4] dark:hover:bg-[#3c4043] transition-colors text-[#5f6368]"
                  aria-label="Close"
                >
                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
